...
def run_odyssey(design, objective, workload, time_out, alpha):
	os.system(f'rm -rf {designs_dir}/*')
	# print(f'{designs_lib_dir}/{workload}/{design}')
	copy_design(design, workload)
	os.system(prj_path + f'/tests/odyssey.sh {workload} {objective} {designs_dir} {time_out} {alpha}')
	return
...
if __name__ == '__main__':
	...
	results_dir = prj_path + f'/results/{workload}/{problem_dims_str}/design_{design}/{objective}/odyssey'
	...
	for idx in design_iter:
		for objective in objectives:
			for trial in range(trials):
				...
				run_odyssey(designs[idx], objective, workload, time_out, alpha)
