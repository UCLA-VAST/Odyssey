...
designs_dir = prj_path + '/scratch/tmp/designs'
output_dir = prj_path + '/scratch/tmp/outputs'

def print_latency_est_func(f, desp, workload):
	...
	if workload == 'mm':
		...
		f.write('var i_t1 >= 1, <= i;\n')
		f.write('var j_t1 >= 1, <= j;\n')
		f.write('var k_t1 >= 1, <= k;\n')
		f.write('var i_t2 >= 1, <= i;\n')
		f.write('var j_t2 >= 1, <= j;\n')
		f.write('var k_t2 >= 1, <= 8.0;\n')
		f.write('var p9  >= 1, <= 16;\n')
		f.write('var p10 >= 1, <= 16;\n')
		f.write('var p11 >= 1, <= 4;\n')
		f.write('var p12 >= 1, <= 4;\n')
	elif workload == 'conv':
		f.write('param i;\n')
		...
		f.write('param bram_bound;\n')
		f.write('param data_w;\n')
		f.write('var i_t1 integer >= 1, <= i;\n')
		f.write('var o_t1 integer >= 1, <= o;\n')
		f.write('var r_t1 integer >= 1, <= r;\n')
		f.write('var c_t1 integer >= 1, <= c;\n')
		f.write('var i_t2 integer >= 1, <= i;\n')
		f.write('var o_t2 integer >= 1, <= o;\n')
		f.write('var r_t2 integer >= 1, <= r;\n')
		f.write('var c_t2 integer >= 1, <= c;\n')
		# f.write('var p14 >= 1, <= 16;\n')
		# f.write('var p15 >= 1, <= 4;\n')
		# f.write('var p16 >= 1, <= 4;\n')
		# f.write('var p17 >= 1, <= 4;\n')
